...
public interface IOTAManagementService {
    ...
    Result<BatchCreateTasksResponse, AppError> createUpgradeTasks(List<VehicleId> vehicleIds, OTAVersion targetVersion);
    ...
    record BatchCreateTasksResponse(List<BatchTaskResult> results, int successCount, int failureCount) { }
    record BatchTaskResult(String vehicleId, String taskId, String status, String error) { }
