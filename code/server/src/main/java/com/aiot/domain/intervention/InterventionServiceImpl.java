...
public class InterventionServiceImpl implements InterventionService {
    ...
    private void buildMappingTable() {
        ...
        mappingTable.put(AlertType.LIFE_DETECTION, buildLifeDetectionMappings());
        mappingTable.put(AlertType.COLLISION_DISABILITY, buildCollisionDisabilityMappings());
    ...
    private Map<RiskLevel, List<InterventionInstruction>> buildFatigueMappings() {
        ...
        map.put(RiskLevel.L2_WARNING, List.of(
                InterventionInstruction.of(InterventionInstructionType.VOICE_BROADCAST,
                        "SPEAKER", Map.<String, Object>of("message", "fatigue_warning"), PRIORITY_MEDIUM),
                InterventionInstruction.of(InterventionInstructionType.SEAT_VIBRATION,
                        "DRIVER_SEAT", Map.<String, Object>of("intensity", "medium"), PRIORITY_MEDIUM)
        ));
    ...
    private Map<RiskLevel, List<InterventionInstruction>> buildLifeDetectionMappings() {
        Map<RiskLevel, List<InterventionInstruction>> map = new EnumMap<>(RiskLevel.class);
        map.put(RiskLevel.L1_HINT, Collections.emptyList());
        map.put(RiskLevel.L2_WARNING, Collections.emptyList());
        map.put(RiskLevel.L3_CRITICAL, List.of(
                InterventionInstruction.of(InterventionInstructionType.ALERT,
                        "VEHICLE", Map.<String, Object>of("type", "life_detected"), PRIORITY_URGENT),
                InterventionInstruction.of(InterventionInstructionType.HAZARD_LIGHTS,
                        "EXTERIOR_LIGHTS", Map.<String, Object>of("mode", "double_flash"), PRIORITY_HIGH),
                InterventionInstruction.of(InterventionInstructionType.VOICE_BROADCAST,
                        "EXTERIOR_SPEAKER", Map.<String, Object>of("message", "life_detected_alert"), PRIORITY_HIGH)
        ));
        return map;
    }

    private Map<RiskLevel, List<InterventionInstruction>> buildCollisionDisabilityMappings() {
        Map<RiskLevel, List<InterventionInstruction>> map = new EnumMap<>(RiskLevel.class);
        map.put(RiskLevel.L1_HINT, Collections.emptyList());
        map.put(RiskLevel.L2_WARNING, Collections.emptyList());
        map.put(RiskLevel.L3_CRITICAL, List.of(
                InterventionInstruction.of(InterventionInstructionType.HAZARD_LIGHTS,
                        "EXTERIOR_LIGHTS", Map.<String, Object>of("mode", "double_flash"), PRIORITY_URGENT),
                InterventionInstruction.of(InterventionInstructionType.NAVIGATE_DECELERATION,
                        "NAVIGATION", Map.<String, Object>of("speed_reduction", "true"), PRIORITY_URGENT),
                InterventionInstruction.of(InterventionInstructionType.NAVIGATE_TO_SHOULDER,
                        "NAVIGATION", Map.<String, Object>of("target", "shoulder"), PRIORITY_URGENT),
                InterventionInstruction.of(InterventionInstructionType.ALERT,
                        "VEHICLE", Map.<String, Object>of("type", "collision_disability"), PRIORITY_URGENT)
        ));
        return map;
    }
    ...
    public InterventionResult handleOverride(OverrideSignal signal) {
        if (signal.getType() == OverrideType.BRAKING || signal.getType() == OverrideType.TURNING
            ...
            return new InterventionResult("INTERVENTION_OVERRIDDEN", signal.getTimestamp().toEpochMilli());
        }
        return new InterventionResult("INTERVENTION_CONTINUED", signal.getTimestamp().toEpochMilli());
    }
}
