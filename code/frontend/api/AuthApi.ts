...
export class AuthApi {
  ...
  async login(request: Record<string, unknown>): Promise<ApiResponse<LoginResponse>> {
  ...
  async refresh(request: Record<string, unknown>): Promise<ApiResponse<RefreshTokenResponse>> {
  ...
  async secondaryVerify(request: Record<string, unknown>): Promise<ApiResponse<SecondaryVerifyResponse>> {
