...
export class FleetApi {
  ...
  async getFatigueDistribution(fleetId: string, params?: Record<string, Object>): Promise<ApiResponse<GetFatigueDistributionResponse>> {
  ...
  async queryTrajectory(fleetId: string, params?: Record<string, Object>): Promise<ApiResponse<QueryTrajectoryResponse>> {
  ...
  async drillDownHighRisk(fleetId: string, params?: Record<string, Object>): Promise<ApiResponse<DrillDownHighRiskResponse>> {
  ...
  async generateReport(body: Record<string, Object>): Promise<ApiResponse<GenerateReportResponse>> {
  ...
  /** GET /api/v1/fleet/reports/{reportId}/download — 返回 ArrayBuffer，不走 fromJson */
  async downloadReport(reportId: string, format: string): Promise<ApiResponse<ArrayBuffer>> {
  ...
  async subscribePerformanceWarning(body: Record<string, Object>): Promise<ApiResponse<SubscribePerformanceWarningResponse>> {
  ...
  async unsubscribePerformanceWarning(subscriptionId: string): Promise<ApiResponse<Record<string, Object>>> {
