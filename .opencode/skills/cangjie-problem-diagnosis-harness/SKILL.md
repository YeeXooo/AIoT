---
name: cangjie-problem-diagnosis-harness
description: "采用「诊断-质询」审议框架完成仓颉项目的问题定位。"
---
...
workdir 应位于工作区的 `diags/` 目录下，命名格式为 `diags/{YYYYMMDDHHMM}_{简要描述}/`，例如 `diags/202604051000_login-crash-diagnosis/`。
