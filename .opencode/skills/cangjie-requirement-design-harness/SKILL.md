---
name: cangjie-requirement-design-harness
...
workdir 应位于工作区的 `requirements/` 目录下，命名格式为 `requirements/{YYYYMMDDHHMM}_{简要描述}/`，例如 `requirements/202604051000_user-auth-requirement/`。
