...
| 模式文件 | 外部技能 | 引用文件 |
|---------|---------|---------|
| component-a-ood.md | architecture-design-harness | designer.md、verifier.md |
| component-a-execution.md | deliberative-execution-harness | executor.md、reviewer.md |
| component-a-diagnosis.md | problem-diagnosis-harness | diagnostician.md、challenger.md |
| component-a-requirement.md | requirement-design-harness | designer.md、verifier.md |
| component-a-technical.md | technical-design-harness | designer.md、verifier.md |
...
- 校验外部文件依赖：根据当前 `mode` 检查对应模式文件所引用的外部技能指令文件是否存在（如 mode=ood 时检查 `{this_skill_dir}/../architecture-design-harness/designer.md` 和 `verifier.md`）。若任一文件不存在，直接向用户报错并终止
- 初始化迭代计数器 `M = 1`
