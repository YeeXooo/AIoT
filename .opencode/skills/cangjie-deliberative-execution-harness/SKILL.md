---
name: cangjie-deliberative-execution-harness
...
workdir 应位于工作区的 `deliberations/` 目录下，命名格式为 `deliberations/{YYYYMMDDHHMM}_{简要描述}/`，例如 `deliberations/202604111600_api-error-analysis/`。
