---
name: cangjie-redeliberation-harness
...
workdir 应位于工作区的 `redeliberations/` 目录下，命名格式为 `redeliberations/{YYYYMMDDHHMM}_{简要描述}/`。
...
| 模式文件 | 外部技能 | 引用文件 |
|---------|---------|---------|
| component-a-ood.md | cangjie-architecture-design-harness | designer.md、verifier.md |
| component-a-execution.md | cangjie-deliberative-execution-harness | executor.md、reviewer.md |
| component-a-diagnosis.md | cangjie-problem-diagnosis-harness | diagnostician.md、challenger.md |
| component-a-requirement.md | cangjie-requirement-design-harness | designer.md、verifier.md |
| component-a-technical.md | cangjie-technical-design-harness | designer.md、verifier.md |
...
- 校验外部文件依赖：根据当前 `mode` 检查对应模式文件所引用的外部技能指令文件是否存在（如 mode=ood 时检查 `{this_skill_dir}/../cangjie-architecture-design-harness/designer.md` 和 `verifier.md`）。若任一文件不存在，直接向用户报错并终止
- 初始化迭代计数器 `M = 1`
