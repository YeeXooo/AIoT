...
复用 cangjie-requirement-design-harness 的子Agent指令文件，启动子Agent时让其自行阅读：

- **需求澄清agent指令**：`{this_skill_dir}/../cangjie-requirement-design-harness/designer.md`
- **需求验证agent指令**：`{this_skill_dir}/../cangjie-requirement-design-harness/verifier.md`
...
```
请先阅读文件 {this_skill_dir}/../cangjie-requirement-design-harness/designer.md 获取完整工作指令，然后按要求完成以下任务：
...
```
请先阅读文件 {this_skill_dir}/../cangjie-requirement-design-harness/verifier.md 获取完整工作指令，然后按要求完成以下任务：
